...
const[empId,setEmpId]=useState(props.empId)
    ...
    return (
        isLoading?<Loading/>:
            ...
            <Card style={{ maxWidth: 670, padding: "13px 5px", margin: "0 auto" ,marginTop:"150px"}}>
                                        <CardContent>
                                             ...
                                             <form onSubmit={handleContact}>
                                                <Grid container spacing={1} >
                                                    ...
                                                    {/* <Grid item xs={12} sx={{justifyContent:"right",display:"flex"}}>
                                                     <Button onClick={handleClose} style={{marginRight:"32px",color:"red",fontWeight:"bold"}}>Cancel</Button>
                                                    </Grid> */}
                                                </Grid>
                                                </form>
                                                <GlobalButton.GlobalDivider/>
