...
const navigate=useNavigate()
    ...
    const button1={backgroundColor:"#2196F3",color:"white",borderRadius:"20px",marginBottom:"20px",width:"26%"}
...
{/* <Box sx={{
    ...
    <Box>
        ...
        <Typography style={{marginLeft:"58px",fontSize:"28px"}}  color="primary">
            Shift Timing
        </Typography>
    </Box>
    </Box> */}
...
<Typography variant='h6'>Shift Start</Typography>
        ...
        <TextField required name="startHour"  value={startTime.startHour}
         onChange={getime11} label="Hour" type="number"  InputProps={{ inputProps: { max:23,min:0} }} 
...
<Typography variant='h6'>Shift End</Typography>
        ...
        <TextField required name="endHour" value={endTime.endHour} onChange={getTime12}
