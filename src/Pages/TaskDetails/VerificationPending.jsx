    ...
    >
      ...
      <Grid item xs={12} sm={12} md={3} lg={3} xl={3} sx={{
            ...
            padding:"20px"
             ...
             <TextField InputLabelProps={{ shrink: true }} style={{width:"390px"}} 
             type='date' value={employee.fromDate} 
             onChange={(e)=>{setEmployee({ ...employee,fromDate:e.target.value})}} label="From Date"></TextField>
...
style={{width:"390px"}} type='date' value={employee.toDate} 
