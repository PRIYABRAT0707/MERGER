...
// BiometricServiceModule.biometricDataUpload(biometric).then((res)=>{
...
return(
    ...
    {/* <Box sx={{
        ...
        <Box sx={{marginTop:"50px"}}>
            ...
            <Typography style={{fontSize:"30px"}} color="#2196F3" sx={{marginLeft:5}}>
                Biometric Data
            </Typography>
        </Box>
    </Box> */}
...
{/* 
             <Dropzone className="" styles={{border:"3px solid red"}}   inputContent="Upload Biometric data" minSizeBytes={0} maxSizeBytes={10485760}>
             1mb=1048576
...
<Grid item xs={12} sx={{display:'flex',
                ...
                alignItems:'center'
                    ...
                    <Button type="submit" variant="contained" style={button1}>Upload</Button>
                </Grid> */}
